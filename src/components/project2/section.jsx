...
function Section() {
  ...
  return (
    ...
    >
      <div className="flex max-md:flex-col max-xl:gap-[32px] justify-between max-sm:py-[51px] pb-[221px]">
        <p
          className={`${
      ...
      <div className="flex w-[1154px] max-xl:w-full mb-[24px] max-md:mb-[12px] gap-[12px] items-center">
